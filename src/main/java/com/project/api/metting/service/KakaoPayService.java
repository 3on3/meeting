...
public class KakaoPayService {
    ...
    public ReadyResponseDto payReady(Map<String, Object> params) {
        ...
        parameters.put("approval_url", "http://mymeetinh-s3-bucket.s3-website.ap-northeast-2.amazonaws.com//payment/approval/");
        parameters.put("cancel_url", "http://mymeetinh-s3-bucket.s3-website.ap-northeast-2.amazonaws.com//");
        parameters.put("fail_url", "http://mymeetinh-s3-bucket.s3-website.ap-northeast-2.amazonaws.com//");
