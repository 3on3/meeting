...
public class KakaoPayService {
    ...
    public ReadyResponseDto payReady(Map<String, Object> params) {
        ...
        parameters.put("approval_url", "http://3.38.26.248:80/payment/approval/");
        parameters.put("cancel_url", "http://3.38.26.248:80/");
        parameters.put("fail_url", "http://3.38.26.248:80/");
